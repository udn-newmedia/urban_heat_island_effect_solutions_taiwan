<template>
  <div class="scrollVideo">
    <section id="videoSection" ref="scrollVideo1" class="scrollVideo">
        <div class="sidebar" id="scroll-video-content1">
          <video ref="video" class="video-player sidebar__inner" width="100vw" id="green" :src="srcRWD(require('../../public/video/green/' + videoMob1), require('../../public/video/green/' + video1) )" preload="metadata" autobuffer autoplay loop muted playsinline></video>
          <source type="video/webm; codecs=&quot;vp8, vorbis&quot;" :src="srcRWD(require('../../public/video/green/' + videoMob1), require('../../public/video/green/' + video1) )" webkit-playsinline="true"></source>
          <source type="video/ogg; codecs=&quot;theora, vorbis&quot;" :src="srcRWD(require('../../public/video/green/' + videoMob1), require('../../public/video/green/' + video1) )"></source>
          <source type="video/mp4; codecs=&quot;avc1.42E01E, mp4a.40.2&quot;" :src="srcRWD(require('../../public/video/green/' + videoMob1), require('../../public/video/green/' + video1) )"></source>
        </div>
        <div class="section">
          <h1>Hello1</h1>
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      videoMob1: 'heat_island_effect_solutions_taiwan_green_mob.mp4',
      frameNumber: 0,
      playbackConst: 500,
      sectionHeight: 0,
      videoDuration: 0
